          ...
          switch (label.name) {
            ...
            case "tests":
              Issue.editLabel(
                label.name,
                {
                  name: ":chart_with_upwards_trend: Needs Tests",
                  color: "0075ca",
                  description: "Needs tests for checking functionality.",
                }
              );
              tests = true;
              break;
            case ":chart_with_upwards_trend: Needs Tests":
              tests = true;
              break;
            case "enhancement":
              Issue.editLabel(
